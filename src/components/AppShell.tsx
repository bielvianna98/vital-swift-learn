    ...
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-30 bg-card/95 backdrop-blur border-b border-border shadow-soft">
        <div className="mx-auto max-w-xl flex items-center justify-between px-4 h-16">
          ...
          <Link
            to="/sobre"
            className="w-10 h-10 rounded-full border-2 border-primary/80 flex items-center justify-center text-primary font-bold hover:bg-medical-soft transition-colors"
            aria-label="Perfil"
          >
            R
          </Link>
